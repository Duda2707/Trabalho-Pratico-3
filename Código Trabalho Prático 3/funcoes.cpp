...
bool finalizaAtendimentos(Hospital *hospital, chrono::system_clock::time_point data_atual)
{
    ...
    for (int i = 0; i < hospital->atendimentos_em_execucao.size(); i++)
    {
        ...
        chrono::system_clock::time_point data_termino_atendimento = chrono::system_clock::from_time_t(mktime(&atendimento.data_termino)); // Transforma a data de termino em time_point
